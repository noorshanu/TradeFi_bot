    ...
    <nav className="h-navbar-height bg-white fixed top-0 left-0 w-full z-[1000]">
      <header className=" bg-white relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="container-wrapper h-[72px] flex items-center justify-between">
          ...
          <aside
            className={twMerge(
              "max-lg:fixed bottom-0 right-0 max-lg:w-[320px] max-lg:h-[calc(100vh-72px)] max-lg:bg-text  flex flex-col lg:flex-row lg:items-center lg:space-x-10 max-lg:text-white lg:[&>*]:text-black/60 [&>*]:tracking-[1px] max-lg:p-5 max-lg:[&>a]:py-2 max-lg:[&>a]:border-b max-lg:[&>a]:px-3 max-lg:[&>a]:mb-2 max-lg:[&>a]:uppercase transition-all duration-200 translate-x-[320px] lg:translate-x-0 z-[1000] max-lg:overflow-y-auto bg-white",
